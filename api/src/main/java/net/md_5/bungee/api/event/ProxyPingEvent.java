 ...
 */
@Data @ToString(callSuper = false) @EqualsAndHashCode(callSuper = false) public class ProxyPingEvent
    ...
    public ProxyPingEvent(PendingConnection connection, ServerPing response,
