 ...
 */
@Data @ToString(callSuper = true) @EqualsAndHashCode(callSuper = true) public class TabCompleteEvent
    ...
    public TabCompleteEvent(Connection sender, Connection receiver, String cursor,
