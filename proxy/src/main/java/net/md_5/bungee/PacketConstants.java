...
public class PacketConstants {
    ...
    public static final PluginMessage FORGE_MOD_REQUEST =
        new PluginMessage("FML", new byte[] {0, 0, 0, 0, 0, 2}, false);
    public static final PluginMessage I_AM_BUNGEE =
        new PluginMessage("BungeeCord", new byte[0], false);
}
