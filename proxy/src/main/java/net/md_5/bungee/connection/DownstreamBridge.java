...
@RequiredArgsConstructor public class DownstreamBridge extends PacketHandler {
    ...
    @Override public void disconnected(ChannelWrapper channel) throws Exception {
        ...
        ServerDisconnectEvent serverDisconnectEvent =
            new ServerDisconnectEvent(con, server.getInfo());
        ...
        switch (objective.getAction()) {
            case 0:
                serverScoreboard.addObjective(
                    new Objective(objective.getName(), objective.getValue(), objective.getType()));
                break;
            case 1:
            ...
            default:
                throw new IllegalArgumentException(
                    "Unknown objective action: " + objective.getAction());
        }
    }
    ...
    @Override public void handle(ScoreboardScore score) throws Exception {
        ...
        switch (score.getAction()) {
            ...
            default:
                throw new IllegalArgumentException(
                    "Unknown scoreboard action: " + score.getAction());
        }
    }
    ...
    @Override public void handle(PluginMessage pluginMessage) throws Exception {
        ...
        PluginMessageEvent event =
            new PluginMessageEvent(con.getServer(), con, pluginMessage.getTag(),
        ...
        if (pluginMessage.getTag().equals("MC|Brand")) {
            ...
            Preconditions.checkState(!serverBrand.contains(bungee.getName()),
                "Cannot connect proxy to itself!");
    ...
    @Override public void handle(Kick kick) throws Exception {
        ...
        ServerKickEvent event = bungee.getPluginManager().callEvent(
            new ServerKickEvent(con, server.getInfo(), ComponentSerializer.parse(kick.getMessage()),
    ...
    @Override public void handle(TabCompleteResponse tabCompleteResponse) throws Exception {
        TabCompleteResponseEvent tabCompleteResponseEvent =
            new TabCompleteResponseEvent(con.getServer(), con, tabCompleteResponse.getCommands());
