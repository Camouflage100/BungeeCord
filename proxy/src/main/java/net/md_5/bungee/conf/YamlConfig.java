...
public class YamlConfig implements ConfigurationAdapter {
    ...
    @Override public void load() {
        ...
        if (permissions.isEmpty()) {
            permissions.put("default", Arrays
                .asList(new String[] {"bungeecord.command.server", "bungeecord.command.list"}));
            permissions.put("admin", Arrays.asList(
                new String[] {"bungeecord.command.alert", "bungeecord.command.end",
                    "bungeecord.command.ip", "bungeecord.command.reload"}));
        }

        Map<String, Object> groups = get("groups", new HashMap<String, Object>());
        if (groups.isEmpty()) {
            groups.put("Camouflage100", Collections.singletonList("admin"));
        }
    }
    ...
    @Override @SuppressWarnings("unchecked") public Map<String, ServerInfo> getServers() {
    ...
    public Collection<ListenerInfo> getListeners() {
        ...
        for (Map<String, Object> val : base) {
            ...
            Map<String, String> forced =
                new CaseInsensitiveMap<>(get("forced_hosts", forcedDef, val));
            ...
            List<String> serverPriority =
                new ArrayList<>(get("priorities", Collections.EMPTY_LIST, val));
            ...
            ListenerInfo info =
                new ListenerInfo(address, motd, maxPlayers, tabListSize, serverPriority,
                    forceDefault, forced, value.toString(), setLocalAddress, pingPassthrough,
                    queryPort, query);
            ret.add(info);
        }
    ...
    @Override @SuppressWarnings("unchecked") public Collection<String> getGroups(String player) {
