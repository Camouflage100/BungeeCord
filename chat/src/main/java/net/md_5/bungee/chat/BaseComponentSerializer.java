...
public class BaseComponentSerializer {
    ...
    protected void deserialize(JsonObject object, BaseComponent component,
        ...
        if (object.has("extra")) {
            component.setExtra(Arrays.<BaseComponent>asList(
    ...
    protected void serialize(JsonObject object, BaseComponent component,
        ...
        try {
            Preconditions
                .checkArgument(!ComponentSerializer.serializedComponents.get().contains(component),
                    "Component loop");
            ...
            if (component.getClickEvent() != null) {
                ...
                clickEvent.addProperty("action",
                    component.getClickEvent().getAction().toString().toLowerCase());
                clickEvent.addProperty("value", component.getClickEvent().getValue());
                object.add("clickEvent", clickEvent);
            }
            if (component.getHoverEvent() != null) {
                JsonObject hoverEvent = new JsonObject();
                hoverEvent.addProperty("action",
                    component.getHoverEvent().getAction().toString().toLowerCase());
